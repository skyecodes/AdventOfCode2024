...
object Day03 : Day<String>(3) {
    override fun parseInput(): String = lines.joinToString("")
    override fun solvePart1(input: String): Number = "mul\\((\\d+),(\\d+)\\)".toRegex().findAll(input)
        .sumOf { it.groupValues.let { (_, a, b) -> a.toInt() * b.toInt() } }
